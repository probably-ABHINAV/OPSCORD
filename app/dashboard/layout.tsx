    ...
    <div style={{ display: "flex", height: "100vh", overflow: "hidden", background: "var(--bg-primary)" }}>
      ...
      >
        ...
        <div style={{ padding: "20px 20px 4px" }}>
          ...
          <div style={{ fontFamily: "var(--font-space-mono)", fontSize: 12, color: "var(--muted)", marginTop: 2 }}>
            Dashboard
          </div>
        </div>
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden" }}>
        ...
        >
          <div>
            ...
            <div style={{ fontSize: 12, color: "var(--muted)", marginTop: -2 }}>OpsCord / {pageTitle}</div>
          </div>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
            ...
            >
              ...
              />
              <span style={{ fontFamily: "var(--font-space-mono)", fontSize: 11, color: "#6ee7b7", fontWeight: 700 }}>
                LIVE
              </span>
            </div>
