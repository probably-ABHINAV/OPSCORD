...
export default function AnalyzerPage() {
  ...
  async function handleChat(e: React.FormEvent) {
    ...
    try {
      ...
      setChatHistory((prev) => [
        ...prev,
        { role: 'model', content: `Error: ${(e as Error).message}` },
      ]);
    } finally {
      setChatting(false);
    }
  ...
  return (
    ...
    >
      ...
      <main
        style={{ flex: 1, padding: '40px 5vw', maxWidth: 1080, margin: '0 auto', width: '100%' }}
      >
        ...
        <form
          ...
          style={{ display: 'flex', gap: 12, maxWidth: 600, margin: '0 auto', marginBottom: 60 }}
        >
          <input
            type="url"
            required
        ...
        {loading && (
          <div style={{ textAlign: 'center', padding: 60 }}>
            ...
            ></div>
            <p
              style={{ color: 'var(--muted)', fontFamily: 'var(--font-space-mono)', fontSize: 13 }}
            >
              EXTRACTING CODE & SCORING CAUSALITY...
            </p>
          </div>
        )}
              ...
              >
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
                  <div
                    style={{
                      background:
                        'linear-gradient(135deg, rgba(239,68,68,0.1) 0%, rgba(15,23,42,1) 100%)',
                  ...
                  >
                    ...
                    >
                      ...
                      <span style={{ fontWeight: 700, color: '#f59e0b' }}>
                        {result.data?.complexityScore}/100
                      </span>
                    </div>
                    <h5
                      style={{
                    ...
                    {result.repoContext ? (
                      ...
                      <p style={{ fontSize: 12, color: 'var(--muted)', textAlign: 'center' }}>
                        Auto-fix requires a Repository URL.
                      </p>
                    )}
                  ...
                  {chatOpen && (
                    ...
                    >
                      ...
                      >
                        ...
                        {chatHistory.map((msg, idx) => (
                          <div
                            ...
                            style={{
                              ...
                              background:
                                msg.role === 'user' ? '#3b82f6' : 'rgba(255,255,255,0.05)',
                              padding: '8px 12px',
                              borderRadius: 8,
                              maxWidth: '85%',
                              fontSize: 13,
                        ...
                        {chatting && (
                          <div style={{ fontSize: 13, color: 'var(--muted)' }}>Thinking...</div>
                        )}
                      </div>
                      <form
                        onSubmit={handleChat}
