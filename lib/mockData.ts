...
export const EVENTS: EventItem[] = [
  { src: "GitHub",   type: "push",    msg: "feat: causality scoring engine v2",    color: "#f0883e", icon: "⬡" },
  { src: "CircleCI", type: "build",   msg: "pipeline #2847 passed — 3m 12s",       color: "#00D4AA", icon: "◎" },
  { src: "K8s",      type: "pod",     msg: "pod/api-7f8b crash-loop detected",     color: "#326CE5", icon: "⎈" },
  { src: "Datadog",  type: "alert",   msg: "p99 latency spike: 320ms → 4.2s",      color: "#a78bfa", icon: "◈" },
  { src: "GitHub",   type: "webhook", msg: "PR #142 merged to main by @dev",       color: "#f0883e", icon: "⬡" },
  { src: "CircleCI", type: "deploy",  msg: "deployed sha:8a3f2c to production",    color: "#00D4AA", icon: "◎" },
  { src: "K8s",      type: "scale",   msg: "HPA scaled api-deployment to 8 pods", color: "#326CE5", icon: "⎈" },
  { src: "Datadog",  type: "metric",  msg: "error rate 0.3% → 2.8% sustained",    color: "#a78bfa", icon: "◈" },
  { src: "SQS",      type: "queue",   msg: "queue depth exceeded: 18,432 msgs",   color: "#FF9900", icon: "⬢" },
  { src: "Redis",    type: "cache",   msg: "cache miss storm — 94% miss rate",     color: "#DC382D", icon: "◆" },
];
...
export const INTEGRATION_LOGOS = [
  "CircleCI", "GitHub", "Kubernetes", "Datadog", "AWS SQS",
  "Redis", "PostgreSQL", "Express.js", "Slack", "React",
];
